...
import (
	...
	"github.com/tobiaskrok/topi/topi-operator/internal/controller/providers"
...
// +kubebuilder:rbac:groups=topi.io,resources=buildjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=topi.io,resources=buildjobs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=topi.io,resources=buildjobs/finalizers,verbs=update
// +kubebuilder:rbac:groups=topi.io,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=topi.io,resources=configmap,verbs=get;list;watch;
// +kubebuilder:rbac:groups=topi.io,resources=secrets,verbs=get;list;watch;
